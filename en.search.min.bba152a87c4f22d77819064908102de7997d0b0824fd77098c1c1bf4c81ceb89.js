...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.985ab892efb06c9db650a034848deeebb4e1210bc938d453338188190599df62.js',function(){input.required=false;search();});}
