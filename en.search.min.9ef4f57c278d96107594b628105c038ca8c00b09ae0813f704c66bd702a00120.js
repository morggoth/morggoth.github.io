...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7dc635bdfbf344a51d2abf2def9446f6d44a45c81561d4403ffa30dccb0caec1.js',function(){input.required=false;search();});}
