...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6a89709860428949212a9d2966b964e8101bf46db071430b90d69ae99654a188.js',function(){input.required=false;search();});}
